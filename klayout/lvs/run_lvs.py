...
def run_check(lvs_file: str, path: str, run_dir: str, sws: dict):
    ...
    logging.info(f'Running Global Foundries 180nm MCU {lvs_file} checks on design {path} on cell {sws["topcell"]}')
...
def main(lvs_run_dir: str, arguments: dict):
    ...
    lvs_rule_deck = os.path.join(os.path.dirname(os.path.abspath(__file__)), "gf180mcu.lvs")
